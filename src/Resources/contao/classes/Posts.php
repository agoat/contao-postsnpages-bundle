...
class Posts extends Frontend
{
	 ...
	 * @return string
	 */
	public static function generatePostUrl (PostModel $objPost, $blnAlternativeLink=false, $blnAbsolute=false): string
	{
		...
		{
			self::$arrUrlCache[$strCacheKey] = Controller::replaceInsertTags($blnAbsolute ? str_replace('}}', '|absolute}}', $objPost->url) : $objPost->url, false);
		}
		else
		{
