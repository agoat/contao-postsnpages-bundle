 ...
 * Palettes
 */
$GLOBALS['TL_DCA']['tl_module']['palettes']['article']  = '{title_legend},name,headline,type;{config_legend},featured,showTeaser,numberOfItems,skipFirst,perPage;{archive_legend},archive,defineRoot;{sort_legend:hide},sortBy, sortOrder;{filter_legend:hide},filterByCategory;{template_legend:hide},articleTpl,customTpl;{image_legend:hide},imgSize;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID';
$GLOBALS['TL_DCA']['tl_module']['palettes']['teaser']  = '{title_legend},name,headline,type;{config_legend},featured,readerModule,numberOfItems,skipFirst,perPage;{archive_legend:hide},archive,defineRoot;{sort_legend:hide},sortBy, sortOrder;{filter_legend:hide},filterByCategory;{template_legend:hide},teaserTpl,customTpl;{image_legend:hide},imgSize;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID';

$bundles = \System::getContainer()->getParameter('kernel.bundles');

if (isset($bundles['ContaoCommentsBundle']))
{
	$GLOBALS['TL_DCA']['tl_module']['palettes']['postreader']  = '{title_legend},name,headline,type;{config_legend},showTeaser;{template_legend:hide},articleTpl,customTpl;{image_legend:hide},imgSize;{comment_legend},allowComments;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID';
}
else
{
	$GLOBALS['TL_DCA']['tl_module']['palettes']['postreader']  = '{title_legend},name,headline,type;{config_legend},showTeaser;{template_legend:hide},articleTpl,customTpl;{image_legend:hide},imgSize;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID';
}
...
(
	...
	'exclude'                 => true,
	'inputType'               => 'select',
	'options_callback'		  => array('tl_module_extendedarticle', 'getArchives'),
	'reference'               => &$GLOBALS['TL_LANG']['tl_module']['archive'],
	'eval'                    => array('tl_class'=>'w50'),
...
(
	...
	'exclude'                 => true,
	'inputType'               => 'select',
	'options'                 => array('date', 'title', 'popular' , 'location'),
	'eval'                    => array('tl_class'=>'w50'),
