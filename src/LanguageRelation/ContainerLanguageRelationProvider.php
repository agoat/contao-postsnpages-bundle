...
class ContainerLanguageRelationProvider extends AbstractLanguageRelationProvider implements
    LanguageRelationProviderInterface
{
    ...
    public function getCreateUrl($language)
    {
        ...
        $query .= (null === $container) ? '&mode=2&pid=' . $this->parentRelations[$language]->id : '&mode=1&pid=' . $container->last(
            )->id;
